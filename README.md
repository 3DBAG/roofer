...
### reconstruct
Takes a point cloud and foorprint for a single building and performs building reconstruction. 
...
## Run with test-data
Assuming you build roofer succesfully. Unzip the contents of [wippolder.zip](https://data.3dgi.xyz/geoflow-test-data/wippolder.zip) into `test-data`, then
