...
namespace git {
  ...
  namespace internal {
    ...
    /// Short-hand method for initializing a std::string or std::string_view
    /// given a C-style const char*.
  ...
  inline const StringOrView CommitSubject() {
    static const StringOrView kValue =
        internal::InitString(git_CommitSubject());
    return kValue;
  }
